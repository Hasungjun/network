...
//         outputStream.write("<h1>이 페이지가 잘 보이면 실습과제 SimpleHttpServer를 시작할 준비가 된 것입니다.</h1>".getBytes("UTF-8"));
   ...
   public static void response400Error(OutputStream outputStream,String tokens) {
	...
	try {
      ...
      outputStream.write(("Content-Type:text/html; charset=utf-8\r\n").getBytes("UTF-8"));
      outputStream.write("\r\n".getBytes()); // 개행을 전후로 header, body 구분
      outputStream.write(body);} catch (IOException e) {
   ...
   public static void response404Error(OutputStream outputStream, String protocol) {
